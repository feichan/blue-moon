...
/******************** add by SunYunrui *******************/
/*
just read remote object as buffer or string
do not download to local
*/
OssClient.prototype.readObject = function (bucket, object, /* userHeaders , */ callback) {
  if (!bucket || !object) {
    throw new Error('error arguments!');
  }
  ...
  options.method = method;
  // new URL rule
  options.url = "http://" + bucket + ".oss.aliyuncs.com/" + object;
  options.encoding = null;
  options.headers = this.getHeaders(method, null, ossParams);
  options.timeout = this._timeout;
